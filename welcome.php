...
<div class="footer">
	...
	<!--Like Button-->
	<iframe class="" src="//www.facebook.com/plugins/like.php?href=http%3A%2F%2Fwww.yoheim.net%2Fapp%2Fewords&amp;width=100&amp;layout=button_count&amp;action=like&amp;show_faces=false&amp;share=false&amp;height=21&amp;appId=231193763645613" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:21px; margin-left:-30px; margin-right:10px;" allowTransparency="true"></iframe>

	<!--Hatebu-->
	<a href="http://b.hatena.ne.jp/entry/http://www.yoheim.net/app/ewords" class="fLeft hatena-bookmark-button" data-hatena-bookmark-title="私の英単語帳-Online" data-hatena-bookmark-layout="standard-balloon" data-hatena-bookmark-lang="ja" title="このエントリーをはてなブックマークに追加"><img src="http://b.st-hatena.com/images/entry-button/button-only@2x.png" alt="このエントリーをはてなブックマークに追加" width="20" height="20" style="border: none;" /></a><script type="text/javascript" src="http://b.st-hatena.com/js/bookmark_button.js" charset="utf-8" async="async"></script>
